...
void	init_scene1(t_scene *scene)
{
	...
	scene->objects[6].type = PLANE;
	scene->objects[6].hidden = CL_FALSE;
	scene->objects[6].scale = init_vec3(1.0f, 1.0f, 1.0f);
	scene->objects[6].rotation = init_vec3(0.f, 0.f, 0.f);
	scene->objects[6].location = init_vec3(0.0f, -1.0f, 0.0f);
	scene->objects[6].color = init_vec3(0.9f, 0.8f, 0.7f);
	scene->objects[6].emi = init_vec3(0.0f, 0.0f, 0.0f);
	scene->objects[6].diffuse = 1.0f;
	scene->objects[6].specular = 0.0f;
	scene->objects[6].spec_exp = 0.5f;

	scene->objects[7].id = 7;
	scene->objects[7].type = CONE;
	scene->objects[7].hidden = CL_FALSE;
	scene->objects[7].scale = init_vec3(.5f, 1.f, .5f);
	scene->objects[7].rotation = init_vec3(-15.f, 0.f, -15.f);
	scene->objects[7].location = init_vec3(0.0f, 2.0f, -2.0f);
	scene->objects[7].color = init_vec3(0.95f, 0.0f, 0.0f);
	scene->objects[7].emi = init_vec3(0.0f, 0.0f, 0.0f);
	scene->objects[7].capped = CL_FALSE;
	scene->objects[7].diffuse = 0.8f;
	scene->objects[7].specular = 0.8f;
	...
	scene->objects[10].id = 10;
	scene->objects[10].type = BOX;
	scene->objects[10].hidden = CL_FALSE;
	scene->objects[10].scale = init_vec3(2.f, 3.f, .05f);
	scene->objects[10].rotation = init_vec3(0.f, 60.f, -30.f);
	scene->objects[10].location = init_vec3(-2.5f, 1.0f, -2.0f);
	scene->objects[10].color = init_vec3(1.0f, 0.49f, 0.0f);
	scene->objects[10].emi = init_vec3(0.0f, 0.0f, 0.0f);
	scene->objects[10].diffuse = 0.9f;
	scene->objects[10].specular = 0.9f;
	scene->objects[10].spec_exp = 20.0f;
